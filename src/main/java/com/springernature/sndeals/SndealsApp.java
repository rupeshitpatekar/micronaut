package com.springernature.sndeals;

import com.springernature.sndeals.config.DefaultProfileUtil;
...
@OpenAPIDefinition(
    info = @Info(
        title = "sndeals",
        version = "0.0",
        description = "sndeals API"
    )
)
public class SndealsApp {

    private static final Logger log = LoggerFactory.getLogger(SndealsApp.class);

    /**
     * Initializes SndealsApp.
     * <p>
