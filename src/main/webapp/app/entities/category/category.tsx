  ...
  return (
    <div>
      <h2 id="category-heading">
        <Translate contentKey="sndealsApp.category.home.title">Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="sndealsApp.category.home.createLabel">Create new Category</Translate>
        </Link>
      </h2>
        ...
        {categoryList && categoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('internalId')}>
                  <Translate contentKey="sndealsApp.category.internalId">Internal Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('displayName')}>
                  <Translate contentKey="sndealsApp.category.displayName">Display Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="sndealsApp.category.home.notFound">No Categories found</Translate>
            </div>
          )
        )}
      </div>
