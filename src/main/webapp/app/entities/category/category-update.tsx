  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sndealsApp.category.home.createOrEditLabel">
            <Translate contentKey="sndealsApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : categoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="internalIdLabel" for="category-internalId">
                  <Translate contentKey="sndealsApp.category.internalId">Internal Id</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="displayNameLabel" for="category-displayName">
                  <Translate contentKey="sndealsApp.category.displayName">Display Name</Translate>
                </Label>
                <AvField
