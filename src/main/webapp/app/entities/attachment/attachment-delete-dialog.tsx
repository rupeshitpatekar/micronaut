...
export const AttachmentDeleteDialog = (props: IAttachmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sndealsApp.attachment.delete.question">
        <Translate contentKey="sndealsApp.attachment.delete.question" interpolate={{ id: attachmentEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-attachment" color="danger" onClick={confirmDelete}>
