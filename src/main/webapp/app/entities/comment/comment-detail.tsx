...
export const CommentDetail = (props: ICommentDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="sndealsApp.comment.detail.title">Comment</Translate> [<b>{commentEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="comment">
              <Translate contentKey="sndealsApp.comment.comment">Comment</Translate>
            </span>
          </dt>
          <dd>{commentEntity.comment}</dd>
          <dt>
            <Translate contentKey="sndealsApp.comment.post">Post</Translate>
          </dt>
          <dd>{commentEntity.postTitle ? commentEntity.postTitle : ''}</dd>
        </dl>
