  ...
  return (
    <div>
      <h2 id="comment-heading">
        <Translate contentKey="sndealsApp.comment.home.title">Comments</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="sndealsApp.comment.home.createLabel">Create new Comment</Translate>
        </Link>
      </h2>
        ...
        {commentList && commentList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('comment')}>
                  <Translate contentKey="sndealsApp.comment.comment">Comment</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="sndealsApp.comment.post">Post</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {commentList.map((comment, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{comment.postTitle ? <Link to={`post/${comment.postId}`}>{comment.postTitle}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="sndealsApp.comment.home.notFound">No Comments found</Translate>
            </div>
          )
        )}
      </div>
